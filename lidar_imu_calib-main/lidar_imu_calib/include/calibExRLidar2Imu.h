...
{
    double stamp;
    Eigen::Matrix4d T; // xyw: T_l{i-1}_l{i}
    Eigen::Matrix4d gT; // xyw: T_map_l{i}
...
private:
    ...
    vector<pair<Eigen::Quaterniond, Eigen::Quaterniond>> corres1_; // 手眼标定使用的corres
    vector<pair<Eigen::Quaterniond, Eigen::Quaterniond>> corres2_; // 优化用的corres
